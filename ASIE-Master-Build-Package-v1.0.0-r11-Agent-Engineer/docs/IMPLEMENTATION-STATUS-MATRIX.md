...
| Client auth screens (login, invite-bound beta registration, local recovery) | Implemented | `src/AuthScreens.tsx` | Closed beta uses normal invitation-bound registration only; Google OAuth and external email delivery are deferred beyond beta |
