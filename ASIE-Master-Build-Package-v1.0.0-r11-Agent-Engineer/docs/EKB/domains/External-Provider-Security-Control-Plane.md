...
FC20-03 ما زال `IN_PROGRESS`. التفعيل الخارجي غير مصرح. يلزم قبل الإغلاق إغلاق نافذة DNS pinning، وصحة وعقود استجابة فعلية لكل مزود. SQLite الحالي صالح لمضيف مشترك؛ النشر متعدد المضيفات يحتاج مخزنًا موزعًا منفصلًا قبل التفعيل.
