...
from backend.runtime_freeze import runtime_freeze_status
...
def build_architecture_runtime_status() -> dict[str, Any]:
    ...
    freeze_status = runtime_freeze_status()
    ...
    acceptance_checks = [
        ...
        {
            "check_id": "AAS-FINAL-09",
            "label": "AAS Runtime v1.0 is frozen behind Architectural Change Request control",
            "passed": (
                freeze_status["status"] == "frozen"
                and freeze_status["version"] == "1.0"
                and freeze_status["architectural_change_request_required"] is True
                and freeze_status["legacy_compatibility"]["production_reachable"] is False
            ),
            "evidence": "freeze=1.0 ACR=required build_overview=non-production",
        },
    ]
    ...
    return {
        ...
        "guards": {
            ...
            "requires_architectural_change_request": True,
